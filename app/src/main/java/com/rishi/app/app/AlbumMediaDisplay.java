...
//        }
        ...
        if (id == R.id.add_media) {
            ...
            for(int i=0;i<albumMediaList.size();i++){
                ids.add(albumMediaList.get(i).getId());
            }
        ...
        if (id == R.id.select) {
           Intent i = new Intent(AlbumMediaDisplay.this,AlbumMediaSelect.class);
    ...
    public void showeditalbumtitle(){
        ...
        final View dialogView = inflater.inflate(R.layout.album_media_edit_album_title, null);
        dialogBuilder.setView(dialogView);

        final EditText edt = (EditText) dialogView.findViewById(R.id.edit_album_title);
        edt.setText(NAME);
        ...
        dialogBuilder.setPositiveButton("Done", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                final EditText edt1 = (EditText) dialogView.findViewById(R.id.edit_album_title);
    ...
    public void showdelete(){
        ...
        alertDialogBuilder.setMessage("Discard Album?");
